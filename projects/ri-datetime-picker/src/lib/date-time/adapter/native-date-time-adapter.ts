...
import { DateTimeAdapter, RI_DATE_TIME_LOCALE } from "./date-time-adaptor";
import { Platform } from "@angular/cdk/platform";
import { createDate, getNumDaysInMonth } from "../../utils/date.utils";
import { range } from '../../utils/array.utils';
import { SUPPORTS_INTL_API, DEFAULT_MONTH_NAMES, DEFAULT_DAY_OF_WEEK_NAMES, DEFAULT_DATE_NAMES } from "../../utils/constants";
...
const ISO_8601_REGEX =
  ...
  export class NativeDateTimeAdapter extends DateTimeAdapter<Date> { 
     ...
     constructor(
        @Optional()
        @Inject(RI_DATE_TIME_LOCALE)
        private riDateTimeLocale: string,
        platform: Platform) {
      
         super();
         super.setLocale(riDateTimeLocale);
         this._clampDate = platform.TRIDENT || platform.EDGE;
         this.useUtcForDisplay = !platform.TRIDENT && !platform.EDGE;
     }
