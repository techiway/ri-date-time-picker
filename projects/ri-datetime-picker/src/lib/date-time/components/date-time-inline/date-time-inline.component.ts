import { ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, Inject, Input, OnInit, Optional, Output, ViewChild, forwardRef } from '@angular/core';
...
export const RI_DATETIME_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => RIDateTimeInlineComponent),
  multi: true
};


@Component({
  selector: 'ri-date-time-inline',
  templateUrl: './date-time-inline.component.html',
  styleUrls: ['./date-time-inline.component.scss'],
  host: {
    ['class.ri-dt-inline']: 'riDTInlineClass'
  }, 
  changeDetection: ChangeDetectionStrategy.OnPush,
  preserveWhitespaces: false,
  providers: [RI_DATETIME_VALUE_ACCESSOR]
})
export class RIDateTimeInlineComponent<T> extends RIDateTime<T>  implements OnInit, ControlValueAccessor {
 
  @ViewChild(RIDateTimeContainerComponent, { static: true })
  container: RIDateTimeContainerComponent<T>;
