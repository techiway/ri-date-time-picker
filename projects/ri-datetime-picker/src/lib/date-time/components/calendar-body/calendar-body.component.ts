...
@Component({
  selector: '[ri-date-time-calendar-body]',
  exportAs: 'riDateTimeCalendarBody',
  templateUrl: './calendar-body.component.html',
  styleUrls: ['./calendar-body.component.scss'],
  host: {
      '[class.ri-dt-calendar-body]': 'riDTCalendarBodyClass'
  },
  preserveWhitespaces: false,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RICalendarBodyComponent implements OnInit {
  /**
  ...
  get riDTCalendarBodyClass(): boolean {
      return true;
  }
   ...
   */
  public isSelected(value: number): boolean | void {  
   ...
   * */
  public isInRange(value: number): boolean | void{
    if (this.isInRangeMode) {
        const fromValue = this.selectedValues[0];
        const toValue = this.selectedValues[1];
