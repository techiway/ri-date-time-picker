...
@Component({
  selector: 'ri-date-time-timer-box',
  templateUrl: './timer-box.component.html',
  styleUrls: ['./timer-box.component.scss'], 
  preserveWhitespaces: false,
  changeDetection: ChangeDetectionStrategy.OnPush,
    host: {
        '[class.ri-dt-timer-box]': 'riDTTimerBoxClass',
    }
})
export class RITimerBoxComponent  implements OnInit, OnDestroy {
